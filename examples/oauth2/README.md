...
![Google api screenshot](https://github.com/syndbg/go-swagger/blob/master/examples/oauth2/img/google-api.png)
...
[example_code]: https://github.com/syndbg/go-swagger/blob/master/examples/oauth2/
