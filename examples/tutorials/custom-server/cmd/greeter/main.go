...
import (
	...
	"github.com/syndbg/go-swagger/examples/tutorials/custom-server/gen/restapi"
	"github.com/syndbg/go-swagger/examples/tutorials/custom-server/gen/restapi/operations"
)
