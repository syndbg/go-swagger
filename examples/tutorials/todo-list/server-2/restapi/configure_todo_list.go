...
import (
	...
	"github.com/syndbg/go-swagger/examples/tutorials/todo-list/server-2/restapi/operations"
	"github.com/syndbg/go-swagger/examples/tutorials/todo-list/server-2/restapi/operations/todos"
)
