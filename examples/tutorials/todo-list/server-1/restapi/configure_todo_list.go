...
import (
	...
	"github.com/syndbg/go-swagger/examples/tutorials/todo-list/server-1/restapi/operations"
	"github.com/syndbg/go-swagger/examples/tutorials/todo-list/server-1/restapi/operations/todos"
)
