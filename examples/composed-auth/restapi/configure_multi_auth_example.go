...
import (
	...
	"github.com/syndbg/go-swagger/examples/composed-auth/restapi/operations"

	auth "github.com/syndbg/go-swagger/examples/composed-auth/auth"
	models "github.com/syndbg/go-swagger/examples/composed-auth/models"
)
